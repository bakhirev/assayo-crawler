...
4. Поправте общие настройки приложения в файле ```src/configs/app.json```
5. Поправте список задач (а именно, список репозиториев для обработки) в файле ```/src/configs/tasks.json```
...
<a name="link-"></a>
#### Файл в папке ```src/configs/app.json```
...
<a name="link-"></a>
#### Файл в папке ```src/configs/tasks.json```
